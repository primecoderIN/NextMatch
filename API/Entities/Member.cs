...
[JsonIgnore]
public List<Message> MessagesSent {get;set;} = []; //List of messages sent by the current user

[JsonIgnore]
public List<Message> MessagesReceived {get;set;} = []; //List of messages received by the current user
